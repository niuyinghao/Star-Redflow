...
docker exec -it dbPostgres sh -c "psql -U star -W -h dbServer --command \"`cat content.sql`\""
docker exec -it dbPostgres sh -c "psql -U star -W -h dbServer --command \"`cat content-en.sql`\""
docker cp img/  star:/opt/tomcat/webapps/ROOT/resources/STAR-0000/
